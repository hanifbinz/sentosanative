		...
		<div class="card">
			<div class="card-body login-card-body">
				<div class="login-logo">
					<a href="login.php">
						<font color="blue">
							<b>-Aplikasi Dokumentasi Gudang Sentosa -</b>
						</font>
					</a>
				</div>
				<center>
					<img src="dist/img/bmlogo.jpg" width=180px />
					<br>
					<br>
				</center>
...
if (isset($_POST['btnLogin'])) {  
	...
	//query login
	$sql_login = "SELECT * FROM  user WHERE BINARY email='$email' AND password='$password'";
