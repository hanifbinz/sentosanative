...
if(isset($_GET['kode'])) {
    $sql_cek = "SELECT * FROM angkutan WHERE id_angkutan='" . $_GET['kode'] . "'";
    $query_cek = mysqli_query($koneksi, $sql_cek);
    $data_cek = mysqli_fetch_array($query_cek, MYSQLI_ASSOC); // Menggunakan MYSQLI_ASSOC agar lebih bersih dan tidak perlu menggunakan index string 'jenis_angkutan', 'jenis_barang' saat mengakses data
}
?>
...
<div class="card card-success">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-edit"></i> Ubah Data Angkutan</h3>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="id_angkutan" name="id_angkutan"
                           value="<?php echo $data_cek['id_angkutan']; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="nama_angkutan" name="nama_angkutan"
                           value="<?php echo $data_cek['nama_angkutan']; ?>"/>
                </div>
            </div>
...
if(isset($_POST['Ubah'])) {
    $nama_angkutan = $_POST['id_angkutan'];
